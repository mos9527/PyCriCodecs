...
from PyCriCodecsEx.usm import USM, USMBuilder, ADXCodec

def test_usm_decode_and_mux():
    # Build a USM
    builder = USMBuilder(
        sample_file_path('USM/MPEG1.mp4'),
        sample_file_path('WAV/44100_5s.wav'),
    ...
    audio.save(saved_audio) # !!! Heap corruption
